...
class DatasetCatalog(object):
    DATASET_DIR = "/media/dataset2/DRAM_processed"
    PASCAL_DIR  = "/media/data1/pascalvoc"
    DATASETS = {
        "pascal_sbd_train": {
            "data_dir": "pascal_sbd",
            "data_list": "train.txt"
        ...
        # SEGMENTO EDITED #
        "dram_train": {
            "data_dir": "/media/dataset2/DRAM_processed/",
            "data_list": "train.txt",
            "movement": "imp+exp" # EDITED
        },
        "dram_test": {
            "data_dir": "/media/dataset2/DRAM_processed/",
            "movement": "dram"
    ...
    def get(name, mode, num_classes=12, max_iters=None, transform=None):
        if "pascal_sbd12" in name:
            ...
            data_dir = DatasetCatalog.PASCAL_DIR
            attrs = DatasetCatalog.DATASETS[name]
            return PascalDataSet(data_dir, max_iters=max_iters, num_classes=num_classes, split=mode, transform=transform)
